...
import EgyptHomeBlock from "./EgyptHomeBlock";
 ...
 */
describe("EgyptHomeBlock", () => {
  it("renders nothing rather than a bare heading when the feed is empty", () => {
    const { container } = render(
      <EgyptHomeBlock lang="ar" title="شؤون مصر" seeAllHref="/section/egypt" sectionKey="egypt" cards={[]} />,
    );
  ...
  it("gives the first story the lead and lists the rest underneath", () => {
    render(<EgyptHomeBlock lang="ar" title="شؤون مصر" seeAllHref="/section/egypt" sectionKey="egypt" cards={cards} />);
  ...
  it("degrades to just the lead when that is all there is", () => {
    render(
      <EgyptHomeBlock lang="ar" title="شؤون مصر" seeAllHref="/section/egypt" sectionKey="egypt" cards={cards.slice(0, 1)} />,
    );
