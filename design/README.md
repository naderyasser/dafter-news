> **أرشيف:** هذه حزمة التسليم الأصلية من Claude Design (يوليو 2026) التي بُني عليها الموقع. تُحفظ كمرجع للتصميم فقط؛ التعليمات أدناه موجّهة لوكيل برمجة كان سينفّذ التصميم لأول مرة، وقد نُفّذ بالكامل. للمشروع الفعلي انظر `../README.md`.
